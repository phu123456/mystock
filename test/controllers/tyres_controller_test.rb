...
class TyresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tyre" do
    assert_difference('Tyre.count') do
      post tyres_url, params: { tyre: { brand: @tyre.brand, position: @tyre.position, serial: @tyre.serial, status: @tyre.status, truck_id: @tyre.truck_id } }
    end
  ...
  test "should update tyre" do
    patch tyre_url(@tyre), params: { tyre: { brand: @tyre.brand, position: @tyre.position, serial: @tyre.serial, status: @tyre.status, truck_id: @tyre.truck_id } }
